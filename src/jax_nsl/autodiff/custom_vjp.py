# File location: src/jax_nsl/autodiff/custom_vjp.py
...
def straight_through_estimator_fwd(
    x: jnp.ndarray, threshold: float
...
def huber_loss_vjp_fwd(
    x: jnp.ndarray, delta: float
